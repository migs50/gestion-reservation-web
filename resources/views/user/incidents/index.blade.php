...
<style>
    ...
    .badge-open { background: #fff9e6; color: #f9b17a; }
...
<div class="page-header">
    ...
    <a href="{{ route('user.incidents.create') }}" class="btn-primary" style="background: linear-gradient(135deg, #ff9e54ff 0%, #f9b17a 100%); color: white; padding: 12px 25px; border-radius: 8px; text-decoration: none;">
...
<div class="glass-card" style="background: white; padding: 30px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
    @if($incidents->isEmpty())
        <div style="text-align: center; padding: 40px;">
            ...
            <h3 style="color: #2f3c72ff;">Aucun incident signalé</h3>
            <p style="color: #2f3c72ff;">Utilisez le bouton ci-dessus pour signaler un problème technique.</p>
        </div>
    @else
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f8f9fa;">
                    ...
                    <td style="padding: 15px;">
                        <a href="{{ route('user.incidents.show', $incident) }}" style="color: #fe9e37ff; text-decoration: none; font-weight: 600;">Détails</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
